        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <AnimatedSection>
            <div className="relative flex justify-center lg:justify-end">
              ...
              <div className="relative bg-white p-4 rounded-2xl shadow-2xl w-full max-w-md lg:max-w-xl">
                <img
                  src="https://images.unsplash.com/photo-1516387938699-a93567ec168e?w=800&h=600&fit=crop"
                ...
                <div className="absolute -bottom-6 -left-6 bg-primary text-white p-6 rounded-xl shadow-xl text-center min-w-[140px]">
                  <div className="text-3xl font-bold">Join</div>
                  <div className="text-sm font-medium opacity-90">Our Team</div>
                </div>
              </div>
            </div>
          </AnimatedSection>
