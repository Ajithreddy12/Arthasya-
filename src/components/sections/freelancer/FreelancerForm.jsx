...
import { FormInput, FormTextarea, FormSelect, FormButton } from "../../forms";
import { SectionHeading } from "../../element";
import { useFormValidation } from "../../../hooks";
import { sendFreelancerEmail } from "../../../services";
...
const FreelancerForm = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const result = await sendFreelancerEmail(submissionData);
  ...
  return (
    <section className="py-20 bg-white">
      <Container>
        <AnimatedSection>
          <SectionHeading
            backgroundText="FREELANCE"
            title="Join our creative network."
          />
        </AnimatedSection>
